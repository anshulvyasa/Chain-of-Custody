export const CASE_CONTRACT_ABI = [
    ...
    },
    {
      ...
      "inputs": [
        ...
        { "name": "_docuemntPath", "type": "string", "internalType": "string" }
      ],
      "outputs": [],
      "stateMutability": "nonpayable"
    },
    {
      ...
      "inputs": [
        { "name": "_caseId", "type": "string", "internalType": "string" },
        { "name": "_documentPath", "type": "string", "internalType": "string" },
        { "name": "_hash", "type": "string", "internalType": "string" },
      ...
      "inputs": [
        {
          ...
          "components": [
            { "name": "caseTitle", "type": "string", "internalType": "string" },
            {
              "name": "createdAt",
              "type": "uint256",
